...
var simplemaps_countrymap_mapinfo = {
  map_name: "country",
  state_bbox_array: {
    LKA2470: { y: 1275, x: 97, x2: 262, y2: 1393 },
    LKA2471: { y: 1121, x: 82, x2: 256, y2: 1305 },
    LKA2472: { y: 1345, x: 117, x2: 333, y2: 1566 },
    LKA2449: { y: 814, x: 382, x2: 605, y2: 1093 },
    LKA2448: { y: 1047, x: 350, x2: 612, y2: 1291 },
    LKA2469: { y: 1089, x: 230, x2: 405, y2: 1341 },
    LKA2468: { y: 1062, x: 530, x2: 886, y2: 1579 },
    LKA2463: { y: 1299, x: 242, x2: 583, y2: 1607 },
    LKA2462: { y: 564, x: 30, x2: 232, y2: 1144 },
    LKA2461: { y: 732, x: 120, x2: 417, y2: 1151 },
    LKA2460: { y: 68, x: 151, x2: 436, y2: 279 },
    LKA2467: { y: 991, x: 509, x2: 725, y2: 1469 },
    LKA2466: { y: 1534, x: 331, x2: 486, y2: 1744 },
    LKA2465: { y: 1453, x: 434, x2: 920, y2: 1721 },
    LKA2464: { y: 1514, x: 156, x2: 383, y2: 1726 },
    LKA2452: { y: 702, x: 706, x2: 969, y2: 1086 },
    LKA2453: { y: 667, x: 498, x2: 756, y2: 974 },
    LKA2450: { y: 1144, x: 355, x2: 591, y2: 1375 },
    LKA2451: { y: 936, x: 600, x2: 999, y2: 1483 },
    LKA2456: { y: 316, x: 241, x2: 510, y2: 576 },
    LKA2457: { y: 267, x: 1, x2: 340, y2: 586 },
    LKA2454: { y: 378, x: 497, x2: 790, y2: 753 },
    LKA2455: { y: 410, x: 144, x2: 600, y2: 902 },
    LKA2458: { y: 169, x: 241, x2: 587, y2: 401 },
    LKA2459: { y: 1, x: 12, x2: 441, y2: 173 },
  },
  paths: {
    LKA2470:
      "M256.8 1302l-5.7 6.9-4.8 7.6-1.9 6.2-2.3 5.3 10.9 11.6-9.7 8.7-12.9-3-14.4 6.1 2.9 12.9-8.7-2.2-5.7-13.4-2.3-1.3-2.8-0.5-5.4 6.3-6.9 3.5-4.9-2.3-4.9 0.6-17 14.6-4.9 2.2-5.1 1.2-12.8 4.8-20.4-12.7-0.5 7.4 2.7 8.3 1.4 5.7 0.1 5.5-0.9 1.5-16.5-42.4-6-33.6-0.6-3.3 0-32.1 0.5-1.2 9.6 3.7 7.3 3.8 7.8 1.9 3.4-1.9 4.1-1.6 21.9 6.4 7.6-1.5 7.6-0.6 6 3.7 5.2 4.9 5 2.8 5.1 2 7.8 0.9 9.5-0.5 0.5-8.7 1.8-8.4 7-7 8.7-4 12 1.2 8-2.8 9.6 0.6 7.6 3.9 1.4 8.1-5.9 5.5 0.6 4.3 0.3 4.4z",
    LKA2471:
      "M249.4 1150.7l0.8 6-4.4 3.4-1.1 15.3-5.8 5.4-7 3.7-1.9 12.6 5.4 11.1 10.8-2.5 9.3 2.7-3.3 7.6-6.4 4.4-5.6 13-2.3 12.9 6.6 21.2 0.1 4-1.4 3.7-8 2.8-12-1.2-8.7 4-7 7-1.8 8.4-0.5 8.7-9.5 0.5-7.8-0.9-5.1-2-5-2.8-5.2-4.9-6-3.7-7.6 0.6-7.6 1.5-21.9-6.4-4.1 1.6-3.4 1.9-7.8-1.9-7.3-3.8-9.6-3.7 4.4-10.6 1.2-5-0.1-5.3-21.2-75.2 3-11-0.2 6.8 1.7 4.2 2.3 3.3 2.1 3.9 4.3 14.9 2 3.6 2.8 0 0.6-4.2 1.3-1.8 1.4-0.1-0.1-13.7-1-5.9-2.2-4.9-2.1-1.5-5.8-1.3-2.6-1.7-1.9-3.8 0.7-3.6 1.7-3.2 0.9-3.2-2.6-19.2 10.5 0.5 8.2-2.2 8.6-1.1 3.4 3.9 5.2 0.6 6.5-4 7.7 3 9.4-3.7 16.8-13.3 10.6-0.4 12.2 8.6 12.8-3.8 10.8-7.7 12.3-2.2 4 4.4 1.3 3.8 2.5 3.7 11 12.6 7.7 5.6z",
    LKA2472:
  ...
  names: {
    ...
    LKA2465: "Hambantŏṭa",
    LKA2464: "Gālla",
    LKA2452: "Maḍakalapuva",
    LKA2453: "Pŏḷŏnnaruva",
    LKA2450: "Nuvara Ĕliya",
    LKA2451: "Ampāra",
    LKA2456: "Vavuniyāva",
    LKA2457: "Mannārama",
    LKA2454: "Trikuṇāmalaya",
    LKA2455: "Anurādhapura",
    LKA2458: "Mulativ",
    LKA2459: "Yāpanaya",
  },
  default_regions: {},
  ...
  default_labels: {},
  proj_coordinates: [
    { lat: 7.2647, x: 302.6, lng: 80.3138, y: 1147.4 },
    { lat: 8.1663, x: 616.8, lng: 81.0251, y: 745.3 },
    { lat: 8.85, x: 149.2, lng: 79.9667, y: 439.8 },
  ],
  initial_view: { x2: 1297.1925, x: -287.2125, y2: 1761.44, y: 0.99 },
};
        ...
        setTimeout(function () {
          ...
          of(),
            ...
            (tg = function () {
              if (
                // tO(),
                (oE(), oj(), (this.id || "set" != !this.type) && !og && !oR)
              ) {
                var e,
                  t = oh(this);
